...
using System.Linq;
using System.Text;
using SqlClient = Community.CsharpSqlite.SQLiteClient;

namespace SQLite.Net.Platform.WindowsPhone71
{
    public class SQLiteApiWP7 : ISQLiteApi
    {
        ...
        {
            var dbHandle = (DbHandle)db;
            var stmt = default(Sqlite3.Vdbe);
            int r = Sqlite3.sqlite3_prepare_v2(dbHandle.InternalDbHandle, query, query.Length, ref stmt, 0);
        ...
        {
            Community.CsharpSqlite.Sqlite3.sqlite3 internalDbHandle = null;
        ...
        {
            public DbHandle(Community.CsharpSqlite.Sqlite3.sqlite3 internalDbHandle)
                : this()
            {
                InternalDbHandle = internalDbHandle;
            }

            public Community.CsharpSqlite.Sqlite3.sqlite3 InternalDbHandle { get; set; }
